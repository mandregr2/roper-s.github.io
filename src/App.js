  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ p: 3 }}>
        <Toolbar />
        <Typography>
        <h2>Bem-vindo à Roper-S Análise de Sistemas Ltda.</h2>
        Fundada em 2020, a Roper-S nasceu com o propósito de transformar o cenário tecnológico através do desenvolvimento de sistemas que aliam qualidade, eficiência e inovação. Nosso foco está em entregar soluções especializadas, projetadas para atender às necessidades únicas de cada cliente e impulsionar o valor estratégico de suas operações.  
        ...
        <p>Entre em contato pelo e-mail: andre@roper-s.com</p>
